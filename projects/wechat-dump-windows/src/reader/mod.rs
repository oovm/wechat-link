...
pub fn find_wechat_progresses() -> windows::core::Result<BTreeSet<u32>> {
    let mut wechat_processes: BTreeSet<u32> = BTreeSet::new();
    ...
    for process_info in process_infos {
        ...
        if process_name == "WeChat.exe" {
            wechat_processes.insert(process_info.ProcessId()?);
        }
    }
